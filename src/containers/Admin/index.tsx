...
const StatusDot = styled.span<{ $active: boolean }>`
  ...
  &::before {
    ...
    height: 6px;
    border-radius: 50%;
    background: ${({ $active }) => ($active ? "#52c41a" : "#bfbfbf")};
    flex-shrink: 0;
  }
`;
        ...
        return (
          <Select
            ...
            labelRender={(opt) => {
              ...
              return (
                <RoleTag $role={opt.value as Role}>
        ...
        return (
          ...
          >
            <Switch
              ...
              disabled={isRemoved}
              onChange={(checked) => void handlePermissionChange(p, checked)}
            />
          </Tooltip>
        );
      },
              ...
              <Flex gap={4}>
                <Tooltip title="Reactivate user">
                  <RestoreBtn
                    ...
                    onClick={() => void handleRestoreUser(p)}
                  />
                </Tooltip>
        ...
        <QueryState isLoading={isLoading} error={error}>
            ...
            >
              ...
              <ToolbarWrap>
                ...
                <FilterSelect
                  value={statusFilter}
                  onChange={(v) =>
                    setStatusFilter(v as "all" | "active" | "removed")
                  }
                      ...
                      <CardActions>
                        ...
                        <CardRow>
                          ...
                          <Switch
                            ...
                            disabled={isRemoved}
                            onChange={(checked) =>
                              void handlePermissionChange(p, checked)
                            }
                          />
                        </CardRow>
                        {isRemoved ? (
          ...
          <SectionBlock>
            ...
            >
              ...
              >
                Active Flatmates (
                {allProfiles.filter((p) => p.is_active !== false).length})
              </Typography.Text>
              <Flex wrap gap={6}>
                {allProfiles
            ...
            <Flex align="flex-start" gap={12} wrap>
              <div style={{ flex: 1, minWidth: 200 }}>
                ...
                >
                  Fixed monthly expenses are split equally among this many
                  flatmates.
                </Typography.Text>
                <Flex align="center" gap={8} wrap>
                  ...
                  {allProfiles.filter((p) => p.is_active !== false).length !==
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setMemberCountDraft(
                          allProfiles.filter((p) => p.is_active !== false)
                            .length,
                        )
                      }
                    >
          ...
          <SectionBlock>
            <Typography.Title
              level={5}
              style={{ margin: "0 0 12px", color: "var(--text-strong)" }}
            >
