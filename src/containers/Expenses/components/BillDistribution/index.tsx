import { Flex, Typography, InputNumber, Button, Avatar } from "antd";
import { TeamOutlined, SaveOutlined, UserOutlined } from "@ant-design/icons";
import { BillDistributionCard, MemberCountPreview } from "../styles";

interface BillDistributionProps {
  profiles: Array<{ id: string; full_name: string; is_active?: boolean }>;
  memberCount: number;
  draftMemberCount: number | null;
  isPending: boolean;
