                  ...
                  <MobileRow>
                    <Flex gap={4} wrap>
                      ...
                      {r.ride_riders.length > 2 && (
                        <RiderChip>+{r.ride_riders.length - 2}</RiderChip>
                      )}
                    </Flex>
                    <Flex
                      gap={4}
        ...
        >
          ...
          >
            <Input
              ...
              prefix={<CarOutlined style={{ color: "var(--text-muted)" }} />}
            />
          </Form.Item>
      ...
      footer={
        <Flex justify={onDelete ? "space-between" : "flex-end"} align="center">
          {onDelete && (
            <Popconfirm
              title="Delete this ride?"
              onConfirm={() => void onDelete(ride.id)}
            >
              <Button
                danger
                size="small"
      ...
      <ModalGrid>
        ...
        <InfoBlock>
          ...
          <InfoRow>
            ...
            <InfoValue
              style={{ color: "#909ffa", fontSize: "1rem", fontWeight: 700 }}
            >
