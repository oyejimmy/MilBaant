...
const MemberBalanceCard = styled.div<{
      ...
      render: (_: unknown, r: FlatFundAllocation) =>
        isAdmin ? (
          <Popconfirm
            ...
            onConfirm={() => void handleDeleteAllocation(r.id)}
          >
      ...
      render: (_: unknown, r: FlatFundExpense) =>
        r.created_by === userId || isAdmin ? (
          <Popconfirm
            ...
            onConfirm={() => void handleDeleteExpense(r.id)}
          >
            <Button size="small" danger icon={<DeleteOutlined />} />
          </Popconfirm>
        ) : null,
          ...
          {summaries.length === 0 ? (
            ...
            <Row gutter={[10, 10]}>
              {summaries.map((s) => {
                ...
                const usedPct =
                  s.totalAllocated > 0
                    ? Math.min(100, (s.totalSpent / s.totalAllocated) * 100)
                    : 0;
                return (
                    ...
                    <MemberBalanceCard $status={status}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          ...
                          >
                            +{formatCurrency(s.totalAllocated)}
                          </Typography.Text>
                          <Typography.Text
                  ...
                  <MobileCard key={e.id}>
                    <MobileRow>
                      <Flex gap={6} align="center">
                        ...
                        <Tag
                          color={
                            FLAT_FUND_CATEGORY_COLORS[e.category] ?? "default"
                          }
                    ...
                    {(e.created_by === userId || isAdmin) && (
                      <MobileRow>
                        ...
                        <Popconfirm
                          title="Remove?"
                          onConfirm={() => void handleDeleteExpense(e.id)}
                        >
                          <Button
                            size="small"
                            danger
                  ...
                  <MobileCard key={a.id}>
                    ...
                    <MobileRow>
                      ...
                      {isAdmin && (
                        <Popconfirm
                          title="Remove?"
                          onConfirm={() => void handleDeleteAllocation(a.id)}
                        >
                          <Button
                            size="small"
                            danger
